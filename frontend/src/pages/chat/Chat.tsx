            ...
            {showAuthMessage ? (
                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                       ...
                       <Link to="https://voicebackanalytics.com" className={styles.footerTitleContainer}>
                          <h1 className={styles.footerTitle}><a href="https://voicebackanalytics.com" target="_blank">Powered By Voicebackanalytics </a></h1>
                       </Link>
                   </Stack> 
                    </div>
